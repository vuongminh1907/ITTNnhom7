...
@Component({
  selector: 'app-tam-tru-add',
  templateUrl: './tam-tru-add.component.html',
  styleUrls: ['./tam-tru-add.component.scss']
})
export class TamTruAddComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<TamTruAddComponent>,
  ...
  initForm() {
    this.form = new FormGroup({
      ...
      ma_giay_tam_tru: new FormControl('', Validators.compose([
        Validators.required,
        Validators.pattern(this.dinhDangSoHoChieu)
      ])),
      so_dien_thoai_nguoi_dang_ky: new FormControl('', Validators.compose([
        Validators.required,
      ...
      noi_tam_tru: new FormControl('', Validators.pattern(this.dinhDangDiaChi))
    }
    )
  ...
  save() {
    ...
    let params = {
      ...
      ma_giay_tam_tru: formValue['ma_giay_tam_tru'],
      so_dien_thoai_nguoi_dang_ky: formValue['so_dien_thoai_nguoi_dang_ky'],
      ...
      noi_tam_tru: formValue['noi_tam_tru']
    }

    this.tamTruService.createTamTru(params).subscribe(
      (res) => {
