...
from . import auth, user, user_group, household_book, cuoc_hop, \
            ...
            danh_sach_tham_du, danh_gia_gia_dinh_van_hoa, dong_gop, danh_sach_dong_gop, danh_sach_bat_buoc
...
def register_blueprints(app):
    ...
    app.register_blueprint(dong_gop.api)
    app.register_blueprint(danh_sach_dong_gop.api)
    app.register_blueprint(danh_sach_bat_buoc.api)
